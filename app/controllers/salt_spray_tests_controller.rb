...
private
  ...
  def salt_spray_test_params
    params.require(:salt_spray_test).permit(:shop_order_number, :load_number, :customer, :process_code, :part_number, :sub, 
                                            ...
                                            :flagged_by, :checked_by, :checked_by_archive, :is_sample, :sample_code, :notify_management, :notify_sales, :alloy_percent,
                                            salt_spray_process_steps_attributes: [:id, :chromate, :top_coat, :chromate_other, :top_coat_other, :thickness, :dipping_time, :note, :_destroy, :alloy_percent],
